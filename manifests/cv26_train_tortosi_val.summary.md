...
- Output manifest: `manifests/cv26_train_tortosi_val.csv`
- Seed: `13`
- Label policy: expanded labels, variant first, controlled accents fallback, Tortosi mapped to valencian
- Tortosí policy: `valencian`
- Vote filter: min_up_votes=`None`, max_down_votes=`None`
- Rows before/after vote filter: `689639` / `689639`
...
- Reserved speakers excluded: `1170`
