    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Si no acceptes el desament per a recerca, esborrem totes les gravacions pendents de la sessió en sortir de la pantalla de resultats sense haver optat per desar-les (o quan expira el termini de pendent), i esborrem també els textos llegits, les puntuacions i el resultat final. Les respostes de feedback que hagis enviat (encert, comarca declarada i zona derivada) es poden conservar sense enllaç a la sessió (sense identificador de sessió) per a calibratge agregat del model; no utilitzem l'àudio per a entrenament.",
          ...
          "No demanem nom, correu electrònic ni creació de compte per utilitzar l'oracle. El tractament amb consentiment de recerca és pseudònim (identificador de sessió), no anònim.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Només si ho acceptes explícitament (a la pantalla inicial o al flux de resultats): per emmagatzemar totes les gravacions de la sessió, les puntuacions individuals, el resultat combinat i les metadades associades per a recerca i entrenament futur del prototip. L'única referència geogràfica que pot acompanyar una sessió és la comarca que declares voluntàriament; no inferim cap localització a partir de l'adreça IP ni de cap altra dada de connexió. Això no equival a determinar el teu lloc de naixement ni la teva identitat dialectal personal.",
      ...
      },
      {
        ...
        paragraphs: [
          "Les gravacions pendents de consentiment es guarden temporalment al servidor mentre decideixes. Si rebutges explícitament el desament a la pantalla de resultats, o surts sense haver optat per desar-les, esborrem immediatament totes les gravacions de la sessió de l'emmagatzematge temporal i buidem els textos llegits, les puntuacions i el resultat final; només queden files tècniques marcades com a esborrades.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `Fes-ho des de «Gestiona les meves dades» (hi trobaràs els IDs locals de les sessions d'anàlisi que has acceptat desar i dels comentaris que has enviat) o escrivint a ${PRIVACY_EMAIL} amb els IDs de sessió o comentari. Les sol·licituds es processen manualment, normalment en un termini de 30 dies.`,
